...
import chapter10.VariableB.motorcyclist.utils.AmmunitionReader;
...
public class AmmunitionManager {
    ...
    public AmmunitionManager(List<AmmunitionBase> ammunitionBases) {
        this.ammunitionBases = ammunitionBases;
    }

    public List<AmmunitionBase> getAmmunitionBases() {
        return ammunitionBases;
    }
