...
//            System.out.println(str);
        ...
        if (optionalPhones.isPresent()) {
            ...
            PhoneArray subscribersWithLongDistance = new PhoneArray(phoneArray);
            System.out.println(subscribersWithLongDistance);
//            final String BLANK = ";";
//            StringBuilder str = new StringBuilder();
...
//            System.out.println(str);
        ...
        PhoneArray sortedSubscribers = new PhoneArray(sorted);
        System.out.println(sortedSubscribers);
//        final String BLANK = ";";
//        StringBuilder str = new StringBuilder();
